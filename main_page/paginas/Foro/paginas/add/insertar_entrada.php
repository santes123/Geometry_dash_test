...
<body>
	...
	<!-- FORMULARIO -->
	<?php
		echo "<form method='POST' action='../../acciones/add_entrada.php?idDiscusion=".$idDiscusion."&userId=".$usuario."''>";
	?>
	<form method="POST" action="../../acciones/add_entrada.php?idDiscusion=">
			<fieldset>

			<legend id="formulario">Añade tu comentario</legend>
			<div>
				<label>Titulo : </label><input type="text" name="titulo" maxlength="100" style="width: 200px;" autofocus="autofocus"><br><br>
			</div>
			<div>
				<label>Cuerpo : </label><br>
				<textarea name="cuerpo" maxlength="200" style="width: 400px; height: 120px;"></textarea><br><br>
			</div>
			<br>
